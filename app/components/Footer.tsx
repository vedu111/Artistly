...
// Demo component to show the footer in different themes
function FooterDemo() {
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center justify-between mb-8">
              <div>
                <h1 className="text-4xl font-bold bg-gradient-to-r from-violet-600 via-purple-600 to-blue-600 dark:from-violet-400 dark:via-purple-400 dark:to-blue-400 bg-clip-text text-transparent">
                  Beautiful Footer Demo
                </h1>
                <p className="text-slate-600 dark:text-slate-400 mt-2">
                  A stunning footer that matches your header's energy and visual appeal.
                </p>
              </div>
              <button
                onClick={() => setIsDark(!isDark)}
                className="group relative overflow-hidden px-4 py-2 bg-gradient-to-r from-violet-500 to-purple-500 hover:from-violet-600 hover:to-purple-600 text-white rounded-lg font-medium transition-all duration-300 hover:scale-105 hover:shadow-lg"
              >
            ...
            <div className="space-y-8 mb-16">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="group p-6 bg-gradient-to-br from-violet-50 to-purple-50 dark:from-violet-950/20 dark:to-purple-950/20 rounded-xl border border-violet-200/50 dark:border-violet-800/30 hover:shadow-lg transition-all duration-300">
                  <h3 className="text-lg font-semibold text-violet-700 dark:text-violet-300 mb-2">Visual Consistency</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-sm">
                    The footer now matches your header's gradient styling, interactive elements, and modern aesthetic.
                  </p>
                </div>
                
                <div className="group p-6 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20 rounded-xl border border-blue-200/50 dark:border-blue-800/30 hover:shadow-lg transition-all duration-300">
                  <h3 className="text-lg font-semibold text-blue-700 dark:text-blue-300 mb-2">Interactive Elements</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-sm">
                    Hover effects, gradient buttons, and smooth animations create an engaging user experience.
                  </p>
                </div>
                
                <div className="group p-6 bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/20 dark:to-teal-950/20 rounded-xl border border-emerald-200/50 dark:border-emerald-800/30 hover:shadow-lg transition-all duration-300">
                  <h3 className="text-lg font-semibold text-emerald-700 dark:text-emerald-300 mb-2">Brand Cohesion</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-sm">
                    Maintains your brand's personality with the same sparkles, gradients, and premium feel.
                  </p>
                </div>
              </div>
            </div>
